      ...
      <div className="flex flex-1">
        <aside className="w-72 bg-zinc-950 p-6">
          ...
          <nav className="mt-10 pt-6 border-t border-zinc-800 flex flex-col gap-3">
            ...
            <a href="" className="text-sm text-zinc-400 hover:text-zinc-100">Rap Americano</a>
          </nav>
        </aside>
        <main className="flex-1 p-6">
          ...
          <div className="grid grid-cols-3 gap-4 mt-4">
            <a href="#" className="bg-white/10 group flex items-center gap-4 rounded-md hover:bg-white/20 transition-colors" overflow-hidden>
          ...
          <div className="grid grid-cols-8 gap-4 mt-4">
            <a href="#" className="bg-white/5 p-3 rounded-md flex flex-col gap-2 hover:bg-white/10">
              <Image src="/album.jpg" className="w-full" width={104} height={104} alt="Capa do álbum Wasting Light da banda Foo Fighters" />
